...
_LIGHTNING = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\027\022\025/v1/graph/nodemetrics'),
  ),
  _descriptor.MethodDescriptor(
    name='GetChanInfo',
